package com.luxoft.javabdd.bank.nested;

import com.luxoft.javabdd.bank.AbstractFactory;
import com.luxoft.javabdd.bank.CreditOfferType;
...
class BankTest {
    ...
    class PremiumCreditOfferTest  {
        ...
        class UsualCustomer {
            ...
            void should_Add_And_Remove() {
                assertAll("Premium credit offer -> Usual customer CANNOT be added/removed",
                        () -> assertFalse(premiumCreditOffer.addCustomer(customer)),
                        () -> assertFalse(premiumCreditOffer.removeCustomer(customer))
                );
            }
        }
    }
